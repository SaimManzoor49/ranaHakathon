    ...
    const handleSubmit = async (e) => {
        ...
        if (!title && title.length < 4) {
            ...
            return;
             ...
             addEvents(title, location, date, time, cover, name, description);
                        ...
                        <form>
                            ...
                            <div className="row mt-3">
                                <div className="col text-center">
                                    <button className="btn px-5 py-2 btn-md btn-primary " disabled={isProcessing} onClick={handleSubmit}>{isProcessing ? <div className='spinner spinner-grow spinner-grow-sm'></div> : <>ADD EVENT</>}</button>
                                </div>
                            </div>
                        </form>
                    </div>
